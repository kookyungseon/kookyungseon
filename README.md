...
<!-- 간단한 소개 -->
<p align="center">
  <em>🌱 Double Major Student | 🚀 Full-Stack Developer | 📊 Data Science Enthusiast</em>
</p>
...
<table align="center">
  ...
  <tr>
    <td><strong>☁️ Cloud Convergence Program</strong></td>
    <td>Multicampus</td>
    <td><em>2022</em></td>
  </tr>
</table>
...
<div align="center">
  <img src="https://img.shields.io/badge/🏆%20최우수상-2024%20충청권%20ICT%20이노베이션-gold?style=for-the-badge"/>
  <br>
  <em>SW 개발 부분 최우수상 (세종테크노파크 원장상)</em>
</div>
...
<div align="center">
  <img src="https://img.shields.io/badge/Pixeleye%20Co.,%20Ltd.-Intern-brightgreen?style=for-the-badge&logo=building&logoColor=white"/>
  <br>
  <em>07/29/2024 ~ 08/26/2024</em>
</div>
...
### 🅿️ Designated Parking Management System
**Cloud, Big Data, IoT Project**
> 개인 주차 공간 공유를 통한 주차 공간 부족 문제 해결을 위한 반응형 웹 애플리케이션
- **기간**: Aug 2022 – Feb 2023 (6개월)
- **역할**: Cloud / Front-end (HTML, CSS)
- **기술**: MSA, Cloud Services
...
> 지역별 여행지 및 맛집 추천 웹 애플리케이션
- **기간**: 3학년 2학기
- **역할**: Front-end (React)
- 🔗 [Repository](https://github.com/opensource-develop-project-2023/miwu)

### 🌊 Environmental Awareness Improvement (Water Quality)
**Open Source Basic Project**
> 친환경 세제 인증, 물 관련 퀴즈, 오염된 우수관 신고 기능 제공
- **기간**: 4학년 1학기
- **역할**: Django + DB Management / API 활용 / Front-end (Flutter)
- 🔗 [Repository](https://github.com/Eco-guardians/BOGGLE)

### 🏥 Telemedicine and Emergency Room Matching
**AI Open Source Professional Project**
> 응급실 문제 해결을 위한 AI 챗봇 기반 원격의료 및 응급실 추천 앱
- **기간**: 4학년 1학기
- **역할**: Front-end (XML)
- 🔗 [Repository](https://github.com/code-guhaejo/CodeBlack)

### 💊 Pill Recognition and Management App
**🏆 Excellence Award Winner**
> 사진 업로드 및 이미지 인식을 통한 알약 정보 및 복약 관리 앱
- **기간**: Aug 2024 – Oct 2024 (3개월)
- **역할**: Django + DB Management / 알약 인식 모델 개발
- **수상**: 2024 충청권 ICT 이노베이션 SW 개발 부분 최우수상
- 🔗 [Repository](https://github.com/Algorithmstudy01/ict_ver2)

### 🪟 Smart Window Project
**IoT Ventilation System**
> IoT 센서를 활용한 공기질, 온도, 습도 기반 자동 창문 개폐 시스템
- **기간**: 4학년 3학기
- **역할**: Backend API 개발 / 공공데이터 포털 API 연결 / Raspberry Pi 통신
- 🔗 [Repository](https://github.com/kangeunsong/SOOM)
