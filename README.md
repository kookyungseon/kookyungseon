...
<!-- 타이틀 타이핑 효과 -->
<a href="https://git.io/typing-svg"><img src="https://readme-typing-svg.demolab.com?font=Lobster&color=58A6FF&size=35&pause=1000&center=true&vCenter=true&width=435&lines=Hello%2C+I'm+Kookyungseon!" alt="Typing SVG" /></a>
<br>
...
- A smart ventilation system that automatically opens or closes windows based on air quality, temperature, and humidity using IoT sensors.
- Duration: 4th Year, 3rd Semester
- Role: Backend API (FastAPI), Front-end (Flutter), Raspberry Pi Control
- [Repository Link](https://github.com/kangeunsong/SOOM)
